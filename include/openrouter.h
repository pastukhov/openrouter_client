 ...
 *
 * When building with ESP-IDF menuconfig, these use CONFIG_* values.
 * For ESPHome or other builds without Kconfig, sensible defaults are provided.
 */
#ifdef CONFIG_OPENROUTER_DEFAULT_RESPONSE_BUFFER_SIZE
#define OPENROUTER_DEFAULT_RESPONSE_BUFFER_SIZE CONFIG_OPENROUTER_DEFAULT_RESPONSE_BUFFER_SIZE
#else
#define OPENROUTER_DEFAULT_RESPONSE_BUFFER_SIZE 4096
#endif

#ifdef CONFIG_OPENROUTER_DEFAULT_TEMPERATURE
#define OPENROUTER_DEFAULT_TEMPERATURE atof(CONFIG_OPENROUTER_DEFAULT_TEMPERATURE)
#else
#define OPENROUTER_DEFAULT_TEMPERATURE 0.7f
#endif

#ifdef CONFIG_OPENROUTER_DEFAULT_MAX_TOKENS
#define OPENROUTER_DEFAULT_MAX_TOKENS CONFIG_OPENROUTER_DEFAULT_MAX_TOKENS
#else
#define OPENROUTER_DEFAULT_MAX_TOKENS 1024
#endif

#ifdef CONFIG_OPENROUTER_DEFAULT_TOP_P
#define OPENROUTER_DEFAULT_TOP_P atof(CONFIG_OPENROUTER_DEFAULT_TOP_P)
#else
#define OPENROUTER_DEFAULT_TOP_P 1.0f
#endif

#ifdef CONFIG_OPENROUTER_DEFAULT_HTTP_TIMEOUT
#define OPENROUTER_DEFAULT_HTTP_TIMEOUT CONFIG_OPENROUTER_DEFAULT_HTTP_TIMEOUT
#else
#define OPENROUTER_DEFAULT_HTTP_TIMEOUT 30000
#endif

#ifdef CONFIG_OPENROUTER_DEFAULT_HTTP_TIMEOUT_STREAMING
#define OPENROUTER_DEFAULT_HTTP_TIMEOUT_STREAMING CONFIG_OPENROUTER_DEFAULT_HTTP_TIMEOUT_STREAMING
#else
#define OPENROUTER_DEFAULT_HTTP_TIMEOUT_STREAMING 60000
#endif
